    ...
    <Card className="mb-3 border border-2 shadow" style={{ transition: 'all 0.3s ease-in-out' }}>
      ...
      <Card.Body>
        ...
        <div className="d-flex justify-content-between align-items-center">
          <Button variant="danger" className='text-white rounded-4' onClick={() => addToCart(car)}>Prenota <FontAwesomeIcon icon={faCartShopping} className='text-white ms-2' /></Button>
